      ...
      <div className="container-site" style={{ paddingTop: "4rem", paddingBottom: "2.5rem" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Agribusiness innovator, climate entrepreneur, and business
              development consultant. Co-founder of KR Foods and PalmLoop.
              African Food Changemakers ambassador.
            </p>
            ...
            <div style={{ display: "flex", gap: "0.75rem", marginTop: "1.5rem" }}>
              {socials.map(({ href, label, icon }) => (
                ...
                <a  key={label}
                  ...
                  onMouseLeave={e => {
                    const el = e.currentTarget as HTMLAnchorElement;
                    el.style.borderColor = "rgba(59,181,74,0.25)";
        ...
        <div
          style={{
            borderTop: "1px solid rgba(59,181,74,0.12)",
            paddingTop: "1.5rem",
            display: "flex",
