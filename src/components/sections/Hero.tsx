...
const cyclingWords = ["An Innovator.", "A Climate Entrepreneur.", "A Changemaker."];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ paddingTop: "3rem", paddingBottom: "5rem", width: "100%" }}
      >
        <div
          style={{
            display: "grid",
          ...
          <div>
            <FadeUp delay={0}>
              <div className="tag-pill" style={{ marginBottom: "2rem" }}>
                ...
                />
                Agribusiness Innovator · Climate Entrepreneur
              </div>
            </FadeUp>
            ...
            <FadeUp delay={0.3}>
              ...
              >
                Building transformative agribusinesses and ecosystems that
                strengthen food systems, accelerate climate action, and unlock
                Africa&apos;s agricultural potential at scale.
              </p>
            </FadeUp>
